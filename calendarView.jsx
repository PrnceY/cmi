  ...
  return (<>
    ...
    <div className="modal-overlay" onClick={closeModal}>
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-footer">
          {canEdit && !editing && (<>
            <button className="btn btn-danger btn-sm" onClick={() => setConfirmDlg({ message: `Delete "${event.title}"?`, danger: true, onConfirm: deleteEvent })} disabled={loading}>Delete</button>
